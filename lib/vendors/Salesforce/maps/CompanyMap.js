/**
 * Data mapping between Prolibu Company and Salesforce Account
 * 
 * reverse: false (default) → Prolibu Company → Salesforce Account
 * reverse: true → Salesforce Account → Prolibu Company
 */
...

{
  ...
  companyCode: {
    ...
    textIndex: true,
    hidden: true,
    description: 'Unique keyname used as ID',
    example: 'example-keyname',
    default: [Function: default],
    faker: 'custom.randKeyname',
    fakerArgs: [ 'CMP-' ],
    _type: 'string'
  },
  companyName: {
  ...
  domains: { type: [ [Function: String] ], _type: [ 'string' ] },
  identification: {
    docType: {
      type: [Function: String],
  ...
  primaryEmail: {
    ...
    validate: { validator: [Function: validator], message: 'Invalid value' },
    set: [Function: set],
    _type: 'string'
  },
  primaryPhone: {
    type: [Function: String],
    example: '+57 1 673 9407 ex101',
    faker: 'phone.number',
    _type: 'string'
  },
  phones: {
  ...
  locale: {
    ...
    numberFormat: {
      type: [Function: String],
      description: 'Numbers format e.g: 0,0.00 = 123,456.79',
      example: '0,0.00',
      _type: 'string'
    }
  },
  ...
  industry: {
    ...
    faker: 'custom.randItem',
    fakerArgs: [ [Array] ],
    xquery: { categoryType: 'Company.industry' },
    _type: 'objectid'
  },
  numberOfEmployees: {
  ...
  referedBy: {
    user: {
      type: [Function],
      ref: 'User',
      description: 'User that referred the company',
      _type: 'objectid'
    },
    contact: {
      type: [Function],
      ref: 'Contact',
      description: 'Contact that referred the company',
      _type: 'objectid'
    }
  },
  legalName: { type: [Function: String], eg: 'Pets Co. Ltd.', _type: 'string' },
  brand: {
    logo: {
      type: [Function],
      ref: 'File',
    ...
    color: { type: [Function: String], uiCom: 'ColorPicker', _type: 'string' }
  },
  isAccountOwner: {
    type: [Function: Boolean],
    default: false,
    avoid: 'always',
    description: 'The company that is the owner of the account',
    example: false,
    faker: 'custom.set',
    fakerArgs: [ false ],
    _type: 'boolean'
...

{
  ...
  "childRelationships": [
    ...
    {
      "cascadeDelete": false,
      "childSObject": "AccountCleanInfoChangeEvent",
      "deprecatedAndHidden": false,
      "field": "AccountId",
      "junctionIdListNames": [],
      "junctionReferenceTo": [],
    ...
    {
      "cascadeDelete": false,
      "childSObject": "AssociatedLocationChangeEvent",
      "deprecatedAndHidden": false,
      "field": "ParentRecordId",
      "junctionIdListNames": [],
      "junctionReferenceTo": [],
    ...
    {
      "cascadeDelete": false,
      "childSObject": "AuthProvider",
      "deprecatedAndHidden": false,
      "field": "FlowDefaultAccountId",
      "junctionIdListNames": [],
      "junctionReferenceTo": [],
      "relationshipName": null,
      "restrictedDelete": false
    ...
    {
      "cascadeDelete": false,
      "childSObject": "FulfillmentOrder",
      "deprecatedAndHidden": false,
      "field": "AccountId",
      "junctionIdListNames": [],
      "junctionReferenceTo": [],
      "relationshipName": "FulfillmentOrders",
      "restrictedDelete": false
    },
    {
      "cascadeDelete": false,
      "childSObject": "FulfillmentOrderChangeEvent",
      "deprecatedAndHidden": false,
      "field": "AccountId",
      "junctionIdListNames": [],
      "junctionReferenceTo": [],
    ...
    {
      "cascadeDelete": false,
      "childSObject": "MessagingEndUserChangeEvent",
      "deprecatedAndHidden": false,
      "field": "AccountId",
      "junctionIdListNames": [],
      "junctionReferenceTo": [],
    ...
    {
      "cascadeDelete": false,
      "childSObject": "MessagingSessionChangeEvent",
      "deprecatedAndHidden": false,
      "field": "EndUserAccountId",
      "junctionIdListNames": [],
      "junctionReferenceTo": [],
    ...
    {
      "cascadeDelete": false,
      "childSObject": "PendingOrderSummary",
      "deprecatedAndHidden": false,
      "field": "AccountId",
      "junctionIdListNames": [],
      "junctionReferenceTo": [],
      "relationshipName": "PendingOrderSummaries",
      "restrictedDelete": false
    },
    {
      "cascadeDelete": false,
      "childSObject": "PendingOrderSummaryChangeEvent",
      "deprecatedAndHidden": false,
      "field": "AccountId",
      "junctionIdListNames": [],
      "junctionReferenceTo": [],
    ...
    {
      "cascadeDelete": true,
      "childSObject": "ServiceAppointmentAttendee",
      "deprecatedAndHidden": false,
      "field": "AttendeeId",
      "junctionIdListNames": [],
      "junctionReferenceTo": [],
    ...
    {
      "cascadeDelete": true,
      "childSObject": "UserPrioritizedRecord",
      "deprecatedAndHidden": false,
      "field": "TargetId",
      "junctionIdListNames": [],
      "junctionReferenceTo": [],
    ...
    {
      "cascadeDelete": true,
      "childSObject": "WaitlistParticipant",
      "deprecatedAndHidden": false,
      "field": "ParticipantId",
      "junctionIdListNames": [],
      "junctionReferenceTo": [],
      "relationshipName": "WaitlistParticipants",
      "restrictedDelete": false
    },
    {
      "cascadeDelete": false,
  ...
  "fields": [
    ...
    },
    {
      ...
      "idLookup": false,
      "inlineHelpText": null,
      "label": "Billing State/Province Code",
      "length": 10,
      "mask": null,
      "maskType": null,
      ...
      "picklistValues": [
        ...
        },
        {
          ...
          "validFor": "AAAAAAAAAAAAAAAAAAAAAABA",
          "value": "AG"
        },
        {
          "active": true,
        ...
        },
        {
          ...
          "defaultValue": false,
          "label": "Alabama",
          "validFor": "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAQAA",
          "value": "AL"
        },
        {
          "active": true,
    ...
    },
    {
      ...
      "caseSensitive": false,
      "compoundFieldName": "ShippingAddress",
      "controllerName": "ShippingCountryCode",
      "createable": true,
      "custom": false,
      "defaultValue": null,
      "defaultValueFormula": null,
      ...
      "idLookup": false,
      "inlineHelpText": null,
      "label": "Shipping State/Province Code",
      "length": 10,
      "mask": null,
      "maskType": null,
  ...
  "recordTypeInfos": [
    {
      ...
      "urls": {
        "layout": "/services/data/v64.0/sobjects/Account/describe/layouts/012000000000000AAA"
      }
    }
  ],
  "replicateable": true,
  ...
  "urls": {
    ...
    "uiDetailTemplate": "https://orgfarm-ae0e089d5a-dev-ed.develop.my.salesforce.com/{ID}",
    "uiEditTemplate": "https://orgfarm-ae0e089d5a-dev-ed.develop.my.salesforce.com/{ID}/e",
    "listviews": "/services/data/v64.0/sobjects/Account/listviews",
    "describe": "/services/data/v64.0/sobjects/Account/describe",
    "uiNewRecord": "https://orgfarm-ae0e089d5a-dev-ed.develop.my.salesforce.com/001/e",
